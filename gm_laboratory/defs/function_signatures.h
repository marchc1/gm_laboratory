...
namespace gm_laboratory {
    ...
    DECLARE_SIGSCAN_SIGNATURE_WIN64(ClientDLL_InitRecvTableMgr, "48 89 5C 24 ? 57 B8 ? ? ? ? E8 ? ? ? ? 48 2B E0 48 8B 05 ? ? ? ? 48 33 C4 48 89 84 24 ? ? ? ? 48 8B 0D")
    DECLARE_SIGSCAN_SIGNATURE_WIN64(RecvTable_Init, "41 56 41 57 48 83 EC ? 4C 63 F2 4C 8B F9")
    DECLARE_SIGSCAN_SIGNATURE_WIN64(SV_InitSendTables, "48 89 74 24 ? 57 B8")
}
