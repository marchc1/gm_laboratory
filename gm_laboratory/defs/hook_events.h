...
/// <summary> Runs before client classes initialize in the engine </summary>
DEFINE_MODULE_HOOK(void, PreInitClientClasses, ClientClass*)
/// <summary> Runs after client classes initialize in the engine </summary>
DEFINE_MODULE_HOOK(void, PostInitClientClasses, ClientClass*)


/// <summary> Runs before server classes initialize in the engine </summary>
DEFINE_MODULE_HOOK(void, PreInitServerClasses, ServerClass*)
/// <summary> Runs after server classes initialize in the engine </summary>
DEFINE_MODULE_HOOK(void, PostInitServerClasses, ServerClass*)
