...
{
public:
	static int Increment( int *p) { return ThreadInterlockedIncrement( (ThreadInterlock_t *)p ); }
	static int Decrement( int *p) { return ThreadInterlockedDecrement( (ThreadInterlock_t *)p ); }
};
